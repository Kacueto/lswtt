        ...
        <article className="homeaboutus-container">
            ...
            <section className="aboutus-container">
                ...
                <p>Hello everyone, we are the twins Christian and Camilo Ochoa. We were born in Córdoba (Bolivar) in north Colombia.  We are political scientists Graduated with an emphasis in public policies from the University del Norte Barranquilla. Since, we were children we were fascinated by the cultures of the world and little by little we noticed that our fascination grew more and more to the point of mastering 5 languages: Spanish (Native lenguage), English, Portuguese, German and Italian.
                    ...
                    Our love for teaching and foreign languages ​has grown so much that together we have decided to launch this project to share with you our knowledge and methods to learn and understand about our beautiful Ibero-Maerican culture.
                    We would like to dedicate ourselves wholeheartedly to this project full time, which is why we truly appreciate your donations and count on you to support this proyect and make it grow.
                    Thank you very much!
                    The Twins Christian and Camilo Ochoa.</p>
            </section>
            <Footer />
        </article>
    );
